...
TRUNCATE TABLE TB_WAITLIST, TB_COURSE_TIME, TB_STUDENT_COURSE, TB_COURSE, TB_STUDENT, TB_TEACHER, TB_MAJOR, TB_DEPARTMENT, TB_USER, TB_SYS_PARAM RESTART IDENTITY CASCADE;
...
-- 课程（当前学期 2024-2025-1）
INSERT INTO TB_COURSE (COURSE_NO, COURSE_NAME, COURSE_TYPE, CREDIT, PERIOD, DEPT_ID, TEA_ID, TERM, CAPACITY, SELECTED_NUM, COURSE_DESC, STATUS, DAY_OF_WEEK, START_SLOT, END_SLOT, LOCATION) VALUES
('C001', 'Database Systems', 'Required', 3.0, 48, 1, 1, '2024-2025-1', 50, 0, 'DB fundamentals and practice', '1', 1, 1, 2, 'A201'),
('C002', 'Operating Systems', 'Required', 3.0, 48, 1, 2, '2024-2025-1', 45, 0, 'OS principles', '1', 1, 3, 4, 'A201'),
('C003', 'Python Programming', 'Elective', 2.0, 32, 1, 1, '2024-2025-1', 60, 0, 'Python development cases', '1', 2, 1, 2, 'Lab 101'),
('C004', 'Data Mining & Visualization', 'Elective', 3.0, 48, 1, 3, '2024-2025-1', 60, 0, 'Data science toolkit for DS/SE 专业', '1', 3, 5, 6, 'B303'),
('C005', 'Network Security Practices', 'Required', 3.0, 48, 1, 2, '2024-2025-1', 50, 0, 'Hands-on labs for IS 专业', '1', 2, 3, 4, 'Lab 102'),
('C006', 'Digital Signal Processing', 'Required', 3.0, 48, 2, 4, '2024-2025-1', 45, 0, 'DSP for Communication Engineering 专业', '1', 4, 1, 2, 'C105'),
('C007', 'Wireless Communication Fundamentals', 'Elective', 2.0, 32, 2, 4, '2024-2025-1', 40, 0, 'Link budget & RF basics', '1', 4, 3, 4, 'C106'),
('C008', 'FinTech Engineering', 'Required', 3.0, 48, 3, 5, '2024-2025-1', 55, 0, 'Financial technology for FIN 专业', '1', 5, 1, 2, 'D201'),
('C009', 'Quantitative Risk Management', 'Elective', 2.0, 32, 3, 5, '2024-2025-1', 45, 0, 'Risk modeling with cases', '1', 5, 3, 4, 'D202');

-- 课程时间片：便于冲突检测与课表渲染
INSERT INTO TB_COURSE_TIME (COURSE_ID, TERM, DAY_OF_WEEK, START_SLOT, END_SLOT, LOCATION) VALUES
(1, '2024-2025-1', 1, 1, 2, 'A201'),
(2, '2024-2025-1', 1, 3, 4, 'A201'),
(3, '2024-2025-1', 2, 1, 2, 'Lab 101'),
(4, '2024-2025-1', 3, 5, 6, 'B303'),
(5, '2024-2025-1', 2, 3, 4, 'Lab 102'),
(6, '2024-2025-1', 4, 1, 2, 'C105'),
(7, '2024-2025-1', 4, 3, 4, 'C106'),
(8, '2024-2025-1', 5, 1, 2, 'D201'),
(9, '2024-2025-1', 5, 3, 4, 'D202');
